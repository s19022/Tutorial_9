    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task1()
        {
            ...
            {
                var res = Emps.Where(e => e.Job == "Backend programmer");
            }
        }
        ...
        public void Task5()
        {
            var res = Emps.Select(e => new { FirstName = e.Ename, EmployeeJob = e.Job });
        }
        ...
        public void Task8()
        {
            bool res = Emps.Where(e => e.Job == "Backend programmer").Count() != 0;
        }
